//! math.rs
//!
//!     Define helpers functions for computing arithmetic
...
pub mod polynomial {
    ...
    pub fn full_lagrange(xs: Vec<u8>, fxs: Vec<u8>) -> Vec<u8> {
        ...
        for i in 0..fxs.len() {
            ...
            this_polynomial = multiply_polynomials(this_polynomial, [fxs[i]].to_vec());
